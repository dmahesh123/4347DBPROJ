...
def delete_craft():
    ...
    try:
        ...
        if cursor.rowcount > 0:
            ...
            delete_name_var.delete(0, tk.END)
        else:
...
def update_craft():
    ...
    try:
        ...
        if cursor.rowcount > 0:
            ...
            update_name_var.delete(0, tk.END)
...
delete_name_dropdown['values'] = fetch_craft_names()
...
update_name_dropdown['values'] = fetch_craft_names() 
...
for craft in fetch_craft_names():
