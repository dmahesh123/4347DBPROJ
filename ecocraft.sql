...
CREATE TABLE Supervises (
    ...
    FOREIGN KEY (SupervisedID) REFERENCES Users(UserID)
);
...
CREATE TABLE Recycles (
    MaterialID INT,
    CenterID INT,
    PRIMARY KEY (MaterialID, CenterID),
    FOREIGN KEY (MaterialID) REFERENCES Material(MaterialID),
...
INSERT INTO Instructions (InstructionID, CraftID, StepNumber, Description)
VALUES
...
INSERT INTO CraftMaterialRelation (CraftID, MaterialID, QuantityRequired)
VALUES
(1, 1, 1),
(2, 1, 1),
(3, 2, 20),
...
SELECT * 
FROM Craft
WHERE EstimatedTime > 60;

INSERT INTO Material (MaterialID, MaterialName, Quantity, Price, MaterialType)
VALUES (11, 'Cardboard', 50, 0.75, 'Paper');

DELETE FROM Tool
WHERE ToolID = 5;

UPDATE Craft
SET DifficultyLevel = 'Very Hard'
WHERE CraftID = 3;
