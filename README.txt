...
If you need more help, please feel free to message Dharshini Mahesh on Teams or email dxm210052@utdallas.edu
...
4.  To load the database schema, open SQL Management Studio and use the provided EcoCraft.sql to set up the database schema. Execute the SQL file to create and populate the data in the SQL environment. If errors occur, please execute the create statements, then the population statements. 


5. Run the GUI program using main.py in your IDE (we used PyCharm) as the source file and ensure that you replace the fields in the connection code with your information as mentioned in step 4.
What you need to replace is mentioned below.
...
Examples for Updating and Deleting: Try deleting/updating craft names "DIY Picture Frame" or "Lego Robot"!
